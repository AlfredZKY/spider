...
def crawler_photo(type_id,photo_count):
    # 最新1，最热2，女生3，星空4
    if(type_id == 1):
        url = 'https://service.paper.meiyuan.in/api/v2/columns/flow/5c68ffb9463b7fbfe72b0db0?page=1&per_page={0}'.format(photo_count)
    elif(type_id == 2):
        url = 'https://service.paper.meiyuan.in/api/v2/columns/flow/5c69251c9b1c011c41bb97be?page=1&per_page={0}'.format(photo_count)
    elif(type_id == 3):
        url = 'https://service.paper.meiyuan.in/api/v2/columns/flow/5c81087e6aee28c541eefc26?page=1&per_page={0}'.format(photo_count)
    elif(type_id == 4):
        url = 'https://service.paper.meiyuan.in/api/v2/columns/flow/5c81f64c96fad8fe211f5367?page=1&per_page={0}'.format(photo_count)
...
if __name__ == '__main__':
    ...
    while True:
        ...
        # 选择壁纸类型
        wall_paper_id = input('壁纸类型：最新壁纸1，最热壁纸2，女生壁纸3，星空壁纸4\n请输入编号以便选择5K超清壁纸类型：')
