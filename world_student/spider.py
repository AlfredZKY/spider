...
def save_csv(tb):
    tb.to_csv(dir_path_data + r'university.csv', mode='a',
              encoding='utf-8_sig', header=True, index=0)
...
def analysis():
    ...
    # 输出结果
    df.to_csv(dir_path_data + r'university_ranking.csv', mode='w',
              encoding='utf-8_sig', header=True, index=False)
